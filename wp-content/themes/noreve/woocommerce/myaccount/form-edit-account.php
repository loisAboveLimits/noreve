...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<div class="row">
		...
		<div class="col-md-6">
			<input type="text" class="woocommerce-Input woocommerce-Input--text input-text form-control gernatic-form" name="account_first_name" id="account_first_name" autocomplete="given-name" value="<?php echo esc_attr( $user->first_name ); ?>" aria-required="true" placeholder="<?php esc_html_e( 'First name', 'woocommerce' ); ?>"/>
			<div class="spacer-20"></div>
		</div>

		<div class="col-md-6">
			<input type="text" class="woocommerce-Input woocommerce-Input--text input-text form-control gernatic-form" name="account_last_name" id="account_last_name" autocomplete="family-name" value="<?php echo esc_attr( $user->last_name ); ?>" aria-required="true" placeholder="<?php esc_html_e( 'Last name', 'woocommerce' ); ?>"/>
			<div class="spacer-20"></div>
		</div>

		<div class="col-md-6">
			<input type="text" class="woocommerce-Input woocommerce-Input--text input-text form-control gernatic-form" name="account_display_name" id="account_display_name" aria-describedby="account_display_name_description" value="<?php echo esc_attr( $user->display_name ); ?>" aria-required="true" placeholder="<?php esc_html_e( 'Display name', 'woocommerce' ); ?>"/> <small><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'woocommerce' ); ?></small>
			<div class="spacer-20"></div>
		</div>

		<div class="col-md-6">
			<input type="email" class="woocommerce-Input woocommerce-Input--email input-text form-control gernatic-form" name="account_email" id="account_email" autocomplete="email" value="<?php echo esc_attr( $user->user_email ); ?>" aria-required="true" placeholder="<?php esc_html_e( 'Email address', 'woocommerce' ); ?>"/>
			<div class="spacer-20"></div>
		</div>					
	...
	<div class="row">
		...
		<div class="col-md-12">
			<input type="password" class="woocommerce-Input woocommerce-Input--password input-text form-control gernatic-form" name="password_current" id="password_current" autocomplete="current-password" placeholder="<?php esc_html_e( 'Current password (leave blank to leave unchanged)', 'woocommerce' ); ?>" />
			<div class="spacer-20"></div>
		</div>

		<div class="col-md-12">
			<input type="password" class="woocommerce-Input woocommerce-Input--password input-text form-control gernatic-form" name="password_1" id="password_1" autocomplete="new-password" placeholder="<?php esc_html_e( 'New password (leave blank to leave unchanged)', 'woocommerce' ); ?>" />
			<div class="spacer-20"></div>
		</div>

		<div class="col-md-12">
			<input type="password" class="woocommerce-Input woocommerce-Input--password input-text form-control gernatic-form" name="password_2" id="password_2" autocomplete="new-password" />
			<div class="spacer-20"></div>
		</div>
	</div>
...
<!-- 	<fieldset>
	...
	<p>
		...
		<button type="submit" class="woocommerce-Button button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?> btn btn-lg btn-gernetic-black-square" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>"><?php esc_html_e( 'Save changes', 'woocommerce' ); ?></button>
