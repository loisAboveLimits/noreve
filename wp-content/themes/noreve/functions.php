...
function noreve_scripts() {
	wp_enqueue_style( 'noreve-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'noreve-style', 'rtl', 'replace' );

	wp_enqueue_script( 'noreve-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
