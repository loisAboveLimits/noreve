jQuery(document).ready(function () {
  ...
  jQuery(document).on("click", ".fbv-cross-install", function (e) {
    // Check if this is the install button from the ads section
    const is_ads_install = jQuery(this).hasClass("njt-ads-install-button");
    e.preventDefault();
    if (
