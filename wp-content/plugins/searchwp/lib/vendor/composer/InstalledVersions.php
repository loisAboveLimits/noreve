 ...
 */
namespace SearchWP\Dependencies\Composer;

use SearchWP\Dependencies\Composer\Autoload\ClassLoader;
use SearchWP\Dependencies\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('SearchWP\\Dependencies\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
